...
// placeholder helper intended to update aggregates when a rating is added
const updateWithRating = async (
  // transaction object provided by runTransaction
  transaction,
  // document reference for the restaurant aggregate
  docRef,
  // new rating document data
  newRatingDocument,
  // original review payload
  review
) => {
  // intentionally a no-op for now (implementation missing)
  return;
};

// placeholder to add a review to a restaurant (implementation omitted)
export async function addReviewToRestaurant(db, restaurantId, review) {
  // intentionally returns immediately; real logic should use transactions
  return;
}
